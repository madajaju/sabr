...
class InputStreamInstance {
    static definition = {
        ...
        statenet: {
            ...
            Enabled: {
                description: "Stream Instance is ready to receive information to the message queues.",
                events: {
                    disable: {
                        Disabled: {},
                    },
            ...
            Disabled: {
                description: "Stream Instance cannot receive information at this time and no transformations are" +
                    " working.",
                events: {
                    enable: {
                        Enabled: {},
        ...
        view: {
            ...
            object3d: (options) => {
                ...
                for (let i in materials) {
                    retval += `<a-entity id="InputStreamInstance3D${i}">` +
...
module.exports = InputStreamInstance;
