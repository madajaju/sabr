...
export default class SService {
    constructor(data) {
        ...
        this.results = data;
        this.instances = [];
        for(let i in data.instances.values) {
            // let instance = new SServiceInstance(data.instances.values[i]);
            let instance = data.instances.values[i];
        ...
        $.ajax({
            ...
            success: (results) => {
                ...
                for (let i in results.records) {
                    let service = new SService(results.records[i]);
