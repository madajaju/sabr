...
permalink: environment--sabr-diml-prod
parent: environment-prod
grand_parent: Environments
---

### Distributed Information Management Layer prod
...
The Distributed Information Management Layer subsystem is physically laid out on a hybrid cloud infrastructure.
...
| --- | --- | --- | --- | --- |
| dsm | sabr_diml_dsm |  |  | children |
| sabm | sabr_diml_sabm |  |  | children |
