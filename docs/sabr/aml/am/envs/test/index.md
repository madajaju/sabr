...
permalink: environment--sabr-aml-am-test
nav_exclude: true
---
...
The Application Manager subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | _am_web |  |  | sibling |
| gw | _am_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname__am_family |
| sibling | internal |  |
