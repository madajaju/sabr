...
The Capability Manager subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | _cm_web |  |  | sibling |
| gw | _cm_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname__cm_family |
| sibling | internal |  |
