...
permalink: environment--sabr-aml-lc-prod
nav_exclude: true
---
...
The Learning Corpus subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | _lc_web |  |  | sibling |
| gw | _lc_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname__lc_family |
| sibling | internal |  |
