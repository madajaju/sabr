...
permalink: environment--sabr-sa-test
nav_exclude: true
---
...
The Security Aspect subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | _s_web |  |  | sibling |
| gw | _s_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname__s_family |
| sibling | internal |  |
