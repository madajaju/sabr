...
permalink: environment--sabr-sa-esc-local
parent: environment-local
grand_parent: Environments
---

### Edge Security Controller local
...
The Edge Security Controller subsystem is physically laid out on a hybrid cloud infrastructure.
