...
permalink: environment--sabr-ia-test
nav_exclude: true
---
...
The Identity Aspect subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | _ia_web |  |  | sibling |
| gw | _ia_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname__ia_family |
| sibling | internal |  |
