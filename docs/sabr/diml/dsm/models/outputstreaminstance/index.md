...
* REST - outputstreaminstance/deploy
* bin - outputstreaminstance deploy
* js - outputstreaminstance.deploy
...
* REST - outputstreaminstance/send
* bin - outputstreaminstance send
* js - outputstreaminstance.send
