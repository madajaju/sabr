...
permalink: environment--sabr-sdi-test
nav_exclude: true
---
...
The Software Defined Infrastructure subsystem is physically laid out on a hybrid cloud infrastructure.
...
| frontend | _sdi_web |  |  | sibling |
| gw | _sdi_gw |  |  | children,sibling |
...
| --- | --- | --- | --- |
| children | egress | appname__sdi_family |
| sibling | internal |  |
